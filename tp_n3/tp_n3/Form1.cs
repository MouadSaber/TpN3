...
namespace tp_n3
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void InsererValeur(string chaine)
        {
            ...
            // l'insértion du texte à la position du curseur
            this.InputText.Text = this.InputText.Text.Insert(this.InputText.SelectionStart, chaine);

            // la réinitialisation de valeur de variable selectionStart à sa valeur initiale 
            this.InputText.SelectionStart = selectionStart + chaine.Length;
